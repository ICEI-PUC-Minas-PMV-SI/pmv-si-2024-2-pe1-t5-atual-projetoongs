...
document.addEventListener('DOMContentLoaded', () => {
    try {
        ...
        try {
            ...
            const abrirModalC = document.getElementById('abrirModalC');
            const fecharModalC = document.getElementById('fecharModalC');
            ...
            if (abrirModalC) {
                abrirModalC.addEventListener('click', () => {
                    try {
                        reiniciarModal();
                ...
                console.warn("Botão 'abrirModalC' não encontrado.");
            }
            ...
            if (fecharModalC) {
                ...
                console.warn("Botão 'fecharModalC' não encontrado.");
            }
            ...
            if (button) {
                ...
                console.warn("Botão 'addPref' não encontrado.");
            }
            ...
            function adicionarPref() {
                try {
                    ...
                    if (valor === '') {
                        alert('Por favor, insira uma preferência.');
                        return;
                    }
            ...
            function mostrarTarefas() {
                try {
                    if (!listaCompleta) {
                        throw new Error("Elemento '.pref' não encontrado.");
                    }
                    listaCompleta.innerHTML = minhasPreferencias
                        .map((tarefa, posicao) => `
                            <li class="selecao" id="list-${posicao}">
                                <img src="../img/delete.png" id="delete-${posicao}" onclick="deletarPref(${posicao})" alt="Excluir preferência">
                                <p>${tarefa}</p>
                            </li>
                        `)
                        .join('');
            ...
            window.deletarPref = function(posicao) {
                try {
